...
\begin{document}
	...
	\begin{enumerate}
		...
		\item $4ac - b^2 = 0$: The second term would be $0$, thus the height along the $y$-axis would be $0$. In other words, the entire $y$-axis would be critical points. This is referred to as the degenerate critical point.
