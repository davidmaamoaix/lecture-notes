...
\begin{document}
	...
	In this form, it is trivial to identify the minimum of $f$. Since both $((x - y) + 1)^2$ and $2y^2$ are squares, their minimum value is $0$, thus the minimum of $f$ is $0 - 1 = -1$. However such an approach is obviously not feasible for all functions.
